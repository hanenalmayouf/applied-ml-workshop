...
# اليوم الثاني — تجهيز خصائص عملاء منافذ في خط معالجة
...
[![Open In Colab — دفتر الطالب](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hanenalmayouf/applied-ml-workshop/blob/main/labs_colab/day2/lab_2_manafeth_preprocessing.ipynb)  **دفتر الطالب** (فيه TODO)

[![Open In Colab — دفتر الحل](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hanenalmayouf/applied-ml-workshop/blob/main/labs_colab/day2/lab_2_manafeth_preprocessing_solution.ipynb)  **دفتر الحل الكامل**
...
| الملف | الوصف |
|---|---|
| `lab_2_manafeth_preprocessing.ipynb` | **دفتر الطالب** — يحتوي على خلايا TODO يكملها الطالب بنفسه، بالإضافة إلى خلايا «فكّر أولًا» و«مساعدة» ورسومات جاهزة. هذا هو الملف الذي يُوزَّع على المتدربين. |
| `lab_2_manafeth_preprocessing_solution.ipynb` | **دفتر الحل الكامل** — نفس الدفتر لكن بكل الخلايا مكتملة ومُنفَّذة، للمدرب أو للمراجعة بعد التسليم. |
| `manafeth_data_package/` | مجلد البيانات: manafeth_customers.parquet (48,000 صف) + data_dictionary.md |
...
2. من القائمة `File → Upload notebook`، ارفعي `lab_2_manafeth_preprocessing.ipynb`.
