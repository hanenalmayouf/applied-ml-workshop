...
# اليوم الخامس — مشروع منافذ المتكامل وفحص تغير التشغيل
...
[![Open In Colab — دفتر الطالب](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hanenalmayouf/applied-ml-workshop/blob/main/labs_colab/day5/final_project_manafeth_churn.ipynb)  **دفتر الطالب** (فيه TODO)

[![Open In Colab — دفتر الحل](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hanenalmayouf/applied-ml-workshop/blob/main/labs_colab/day5/final_project_manafeth_churn_solution.ipynb)  **دفتر الحل الكامل**
...
| الملف | الوصف |
|---|---|
| `final_project_manafeth_churn.ipynb` | **دفتر الطالب** — يحتوي على خلايا TODO يكملها الطالب بنفسه، بالإضافة إلى خلايا «فكّر أولًا» و«مساعدة» ورسومات جاهزة. هذا هو الملف الذي يُوزَّع على المتدربين. |
| `final_project_manafeth_churn_solution.ipynb` | **دفتر الحل الكامل** — نفس الدفتر لكن بكل الخلايا مكتملة ومُنفَّذة، للمدرب أو للمراجعة بعد التسليم. |
| `manafeth_data_package/` | مجلد البيانات: manafeth_customers.parquet + shifted_month.parquet (9,000 صف بلا هدف) + data_dictionary.md |
...
2. من القائمة `File → Upload notebook`، ارفعي `final_project_manafeth_churn.ipynb`.
