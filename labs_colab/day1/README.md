...
# اليوم الأول — كشف التسريب وصياغة مشكلة مغادرة العملاء
...
[![Open In Colab — دفتر الطالب](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hanenalmayouf/applied-ml-workshop/blob/main/labs_colab/day1/lab_1_manafeth_leakage.ipynb)  **دفتر الطالب** (فيه TODO)

[![Open In Colab — دفتر الحل](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hanenalmayouf/applied-ml-workshop/blob/main/labs_colab/day1/lab_1_manafeth_leakage_solution.ipynb)  **دفتر الحل الكامل**
...
| الملف | الوصف |
|---|---|
| `lab_1_manafeth_leakage.ipynb` | **دفتر الطالب** — يحتوي على خلايا TODO يكملها الطالب بنفسه، بالإضافة إلى خلايا «فكّر أولًا» و«مساعدة» ورسومات جاهزة. هذا هو الملف الذي يُوزَّع على المتدربين. |
| `lab_1_manafeth_leakage_solution.ipynb` | **دفتر الحل الكامل** — نفس الدفتر لكن بكل الخلايا مكتملة ومُنفَّذة، للمدرب أو للمراجعة بعد التسليم. |
...
2. من القائمة `File → Upload notebook`، ارفعي `lab_1_manafeth_leakage.ipynb`.
